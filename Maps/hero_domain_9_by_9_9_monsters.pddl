...
(define (domain heroes-world)
   ...
   (:types hero location m0 m1 m2 m3 m4 m5 m6 m7 m8 w0 w1 w2 w3 w4 w5 w6 w7 w8)
  ...
  (:predicates  (at ?o - object ?l - location)		;; Position of an object
                ...
                (has-t2 ?h - hero)			;; Hero armed with weapon t2
                (has-t3 ?h - hero)			;; Hero armed with weapon t3
                (has-t4 ?h - hero)			;; Hero armed with weapon t4
                (has-t5 ?h - hero)			;; Hero armed with weapon t5
                (has-t6 ?h - hero)			;; Hero armed with weapon t6
                (has-t7 ?h - hero)			;; Hero armed with weapon t7
                (has-t8 ?h - hero)			;; Hero armed with weapon t8
   ...
   (:action kill-m5
      :parameters (?h - hero ?m - m5 ?l1 - location ?l2 - location)
      :precondition (and (at ?h ?l1) (at ?m ?l2) (adjacent ?l1 ?l2) (guarded ?l2)
			(has-t5 ?h))
      :effect (and(not (at ?m ?l2)) (not (guarded ?l2)) (at ?h ?l2) (not (at ?h ?l1)) (has-castle ?l2))
   )
   ...
   (:action kill-m6
      :parameters (?h - hero ?m - m6 ?l1 - location ?l2 - location)
      :precondition (and (at ?h ?l1) (at ?m ?l2) (adjacent ?l1 ?l2) (guarded ?l2)
      (has-t6 ?h))
      :effect (and(not (at ?m ?l2)) (not (guarded ?l2)) (at ?h ?l2) (not (at ?h ?l1)) (has-castle ?l2))
   )
   ...
   (:action kill-m7
      :parameters (?h - hero ?m - m7 ?l1 - location ?l2 - location)
      :precondition (and (at ?h ?l1) (at ?m ?l2) (adjacent ?l1 ?l2) (guarded ?l2)
			(has-t7 ?h))
      :effect (and(not (at ?m ?l2)) (not (guarded ?l2)) (at ?h ?l2) (not (at ?h ?l1)) (has-castle ?l2))
   )
   ...
   (:action kill-m8
      :parameters (?h - hero ?m - m8 ?l1 - location ?l2 - location)
      :precondition (and (at ?h ?l1) (at ?m ?l2) (adjacent ?l1 ?l2) (guarded ?l2)
      (has-t8 ?h))
      :effect (and(not (at ?m ?l2)) (not (guarded ?l2)) (at ?h ?l2) (not (at ?h ?l1)) (has-castle ?l2))
   )
   ...
   (:action collect-w5
      :parameters (?h - hero ?w - w5 ?l1 - location)
      :precondition (and (at ?h ?l1) (at ?w ?l1))
      :effect (and (has-t5 ?h) (not (at ?w ?l1)))
   )

   (:action collect-w6
      :parameters (?h - hero ?w - w6 ?l1 - location)
      :precondition (and (at ?h ?l1) (at ?w ?l1))
      :effect (and (has-t6 ?h) (not (at ?w ?l1)))
   )

   (:action collect-w7
      :parameters (?h - hero ?w - w7 ?l1 - location)
      :precondition (and (at ?h ?l1) (at ?w ?l1))
      :effect (and (has-t7 ?h) (not (at ?w ?l1)))
   )

   (:action collect-w8
      :parameters (?h - hero ?w - w8 ?l1 - location)
      :precondition (and (at ?h ?l1) (at ?w ?l1))
      :effect (and (has-t8 ?h) (not (at ?w ?l1)))
   )
)
